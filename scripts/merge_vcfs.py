...
# python /mnt/storage10/lwang/fastq2matrix/scripts/merge_vcfs.py all --sample-file '/mnt/storage10/lwang/Projects/Amplicone_design_tool/model2in1/50k_sample_file.csv' --prefix '50k_vcf_collated' --ref '/mnt/storage10/lwang/trial_tb_philippines/refgenome/MTB-h37rv_asm19595v2-eg18.fa' --vcf-dir '/mnt/storage10/jody/tb_ena/per_sample'